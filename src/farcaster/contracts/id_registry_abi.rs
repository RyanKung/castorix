...
use crate::farcaster::contracts::{
    ...
    types::{Fid, RecoveryAddress, ContractResult},
};
...
impl IdRegistryAbi {
    ...
    pub async fn verify_fid_signature(
        ...
        match self.contract.verify_fid_signature(custody_address, fid.into(), digest_bytes32, signature.into()).call().await {
...
mod tests {
    ...
    async fn test_id_registry_abi_creation() {
        ...
        let address = "0x00000000fc6c5f01fc30151999387bb99a9f489b".parse::<Address>().unwrap();
